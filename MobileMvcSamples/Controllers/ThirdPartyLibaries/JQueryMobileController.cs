...
{
    public class JQueryMobileController : Controller
    {
        public ActionResult Index()
        {
            return View(@"~\Views\ThirdPartyLibraries\JQueryMobile\Index.cshtml");
        }
        ...
        public ActionResult Detail(string id)
        {
            ...
            return View(@"~\Views\ThirdPartyLibraries\JQueryMobile\Detail.cshtml", vm);
        }
